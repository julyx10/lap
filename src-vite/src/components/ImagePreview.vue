<template>
    ...
    <!-- <div 
      :class="[
        'relative w-screen h-screen flex flex-col border border-gray-800 overflow-hidden',
      ...
      >
        ...
        <IconInfo :class="['t-icon-size-sm t-icon-hover', showInfo ? 't-icon-focus' : '']" @click="toggleShowInfo" />
  ...
  const showInfo = ref(false); // Show the file info panel
  ...
  // Close the image profile panel from the child component
