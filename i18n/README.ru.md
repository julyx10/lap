...
- **Быстрый просмотр библиотеки** с фильтрами по времени, папкам, месту, камере, объективу, тегам, избранному, рейтингу и лицам.
- **Локальный ИИ-поиск** для текстовых запросов, визуального сходства, умных тегов, кластеризации лиц и опционального многоязычного поиска на 50+ языках.
